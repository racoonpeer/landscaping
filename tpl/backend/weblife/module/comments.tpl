        ...
        <ul class="tabs">
            <li class="active" id="tab_main">
                <table border="1" cellspacing="0" cellpadding="1" class="list">       
                    ...
                    <tr>
                        <td id="headb" align="left">Соц. сеть</td>
                        <td align="left">
                           <{if !empty($item.network)}> <a target="_blank" href="<{$item.net_url}>"><{$item.network}></a><{else}> --<{/if}>
                        </td>
                    ...
                    <tr>
                        <td colspan="2">  
                            ...
                            <textarea style="width:640px; height: 100px;" name="descr" ><{$item.descr}></textarea>
                        </td>
                        <td class="buttons_row"></td>
                    </tr>    
                </table>
