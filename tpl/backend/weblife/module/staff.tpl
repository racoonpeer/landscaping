<{* +++++++++++++++++ START HEAD ++++++++++++++++++++++ *}>
<{include file='common/module_head.tpl' title=$smarty.const.TOPLINK_USERS creat_title=$smarty.const.ADMIN_CREATING_NEW_PAGE edit_title=$smarty.const.ADMIN_EDIT_CATEGORY_PAGE}>
<{* +++++++++++++++++ END HEAD ++++++++++++++++++++++ *}>
            ...
            <ul class="tabs">
                <li class="active" id="tab_main">
                    <table border="1" cellspacing="0" cellpadding="1" class="list">       
                        <tr>
                            <td id="headb" align="left"><{$smarty.const.FEEDBACK_FIRST_NAME}> <font style="color:red">*</font></td>
                            <td>
                        ...
                        <tr>
                            <td id="headb" align="left"><{$smarty.const.HEAD_SHORT_CONTENT}></td>
                            <td>
                                <input class="field" name="descr" id="descr" size="100" type="text" value="<{$item.descr}>" />
                            </td>
                            <td class="buttons_row"></td>
                        </tr>
                        <tr>
                            <td id="headb" align="left"><{$smarty.const.HEAD_EMAIL}></td>
                            <td>
                                <input class="field" name="email" id="email" size="100" type="text" value="<{$item.email}>" />
                            </td>
                            <td class="buttons_row"></td>
                        </tr>
                        <!-- ++++++++++ Start Attach Files ++++++++++++++++++++++++++++++++++++++++++++++ -->
